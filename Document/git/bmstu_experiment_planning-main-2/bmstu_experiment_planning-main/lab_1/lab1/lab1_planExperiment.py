...
class GaussGenerator:
    def __init__(self, intensity, range_):
        self.m = intensity
        self.sigma = range_
...
class WeibullGenerator:
    def __init__(self, intensity, range_):
        self.k = (range_ / intensity) ** (-1.086)
        self.lamda = (intensity) / math.gamma(1+1/self.k)
...
class mywindow(QMainWindow):
    ...
    def onModelBtnClick(self):
        try:
            ...
            processor = RequestProcessor(WeibullGenerator(intensivity_proc, range_proc))
